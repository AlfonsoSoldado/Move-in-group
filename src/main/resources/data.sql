...
('803','Juan','Hernández Jiménez','juher@mail.com','777777777', '802', 'Soy una persona apasionada del deporte. Me encanta sobre todo lo relacionado con escalada y montañerismo. Si necesitas alguien para acompañarte en tus rutas por la montaña y echar unas risas ese soy yo. Aun siendo así, también puede que me apunte alguna que otra vez a algún partidito de futbol ^^'),
